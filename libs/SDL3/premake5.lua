project "SDL3"
    ...
    defines {
        "SDL_STATIC",
        "__INTELLISENSE__", -- This is a hack to bypass the stupidity of SDL_dynapi.h
    ...
    filter "system:linux"
        ...
        buildoptions { 
            "`pkg-config --cflags libpipewire-0.3 dbus-1`" 
        }
