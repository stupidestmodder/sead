...
class GameFrameworkBaseGlfw : public GameFramework
{
    SEAD_RTTI_OVERRIDE(GameFrameworkBaseGlfw, GameFramework);
...
public:
    explicit GameFrameworkBaseGlfw(const CreateArg& arg);
    ~GameFrameworkBaseGlfw() override;
...
private:
    static GameFrameworkBaseGlfw* sInstance;
