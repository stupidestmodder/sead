...
{
    SEAD_RTTI_OVERRIDE(SDLController, Controller);
...
public:
    ...
    static const s32 cJoyPadNumberInvalid = SDLJoyPadDevice::cNumMax;

public:
    SDLController(ControllerMgr* mgr, s32 joyPadNumber);
